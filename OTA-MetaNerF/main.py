...
def add_arguments(parser):
    ...
    # Model arguments
    parser.add_argument(
        "--num_layers", help="Number of layers in base network.", type=int, default=10
    )
    ...
    parser.add_argument(
        "--w0", help="w0 parameter from SIREN.", type=float, default=50.0
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="wandb/run-20250407_231207-96zs9gy9/files",
    )
...
def main(args):
    ...
    if args.test == False:
        ...
        model, model_args, patcher = load_model(args.wandb_run_path, args.device)
        print(model)
        print(args)
