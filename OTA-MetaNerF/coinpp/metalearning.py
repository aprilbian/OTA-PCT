...
def inner_loop_step(
    ...
    with torch.enable_grad():
        ...
        features_recon = func_rep.noisy_modulated_forward(coordinates, modulations)
        ...
        loss = losses.bce_fn(features_recon, features) * batch_size
...
def outer_step(
    ...
    with torch.set_grad_enabled(is_train):
        ...
        features_recon = func_rep.noisy_modulated_forward(coordinates, modulations)
        print('receiver time:', time.time() - start_time)
        ...
        per_example_loss = losses.bce_fn(features_recon, features)
        # Shape (1,)
